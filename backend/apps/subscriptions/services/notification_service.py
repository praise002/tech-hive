...
class NotificationService:
    ...
    def send_trial_started_email(self, user, subscription: Subscription) -> bool:
        ...
        return self.send_email(
            ...
            template_name="subscriptions/trial_started.html",
            context=context,
        )
    ...
    def send_trial_ending_soon_email(
        ...
        return self.send_email(
            ...
            recipient=user.email,
            template_name="subscriptions/trial_ending_soon.html",
            context=context,
        )
    ...
    def send_retry_scheduled_email(
        ...
        return self.send_email(
            ...
            recipient=user.email,
            template_name="subscriptions/retry_scheduled.html",
            context=context,
        )
    ...
    def send_retry_failed_email(
        ...
        return self.send_email(
            ...
            recipient=user.email,
            template_name="subscriptions/retry_failed.html",
            context=context,
        )
    ...
    def send_final_grace_period_email(self, user, subscription: Subscription) -> bool:
        ...
        return self.send_email(
            ...
            recipient=user.email,
            template_name="subscriptions/final_grace_period.html",
            context=context,
        )
    ...
    def send_subscription_created_email(self, user, subscription: Subscription) -> bool:
        ...
        return self.send_email(
            ...
            recipient=user.email,
            template_name="subscriptions/subscription_created.html",
            context=context,
        )
    ...
    def send_upcoming_charge_email(
        ...
        return self.send_email(
            ...
            recipient=user.email,
            template_name="subscriptions/upcoming_charge.html",
            context=context,
        )
    ...
    def send_cancellation_confirmed_email(
        ...
        return self.send_email(
            ...
            recipient=user.email,
            template_name="subscriptions/cancellation_confirmed.html",
            context=context,
        )
    ...
    def send_reactivation_email(self, user, subscription: Subscription) -> bool:
        ...
        return self.send_email(
            ...
            recipient=user.email,
            template_name="subscriptions/reactivation_success.html",
            context=context,
        )
    ...
    def send_card_updated_email(self, user, subscription: Subscription) -> bool:
        ...
        return self.send_email(
            ...
            recipient=user.email,
            template_name="subscriptions/card_updated.html",
            context=context,
        )
    ...
    def send_card_expiring_email(
        ...
        return self.send_email(
            ...
            recipient=user.email,
            template_name="subscriptions/card_expiring.html",
            context=context,
        )
