      ...
      <div className="mt-30 md:mt-50 flex-col items-center md:items-start md:flex-row flex gap-4 mb-8 px-20">
        <div className="p-3 md:w-fit md:h-fit border border-[#C1C8C7] rounded-lg">
          <div className="flex gap-2 items-center mb-2">
            ...
            <div>
              <p className="font-semibold text-xs sm:text-sm md:text-lg">0 Comments </p>
            </div>
          </div>
          <div className="flex gap-2 items-center">
            ...
            <p className="font-semibold text-xs sm:text-sm md:text-lg">0 Saved </p>
          </div>
        </div>
        <div className="flex-1 p-4 border flex justify-center items-center border-[#C1C8C7] rounded-lg">
          <div className="md:w-xs w-60">
            <img
              ...
              alt=""
            />
            <div className='text-xs md:text-sm text-center'>No comments or saved articles yet!</div>
          </div>
        </div>
      </div>
    </div>
