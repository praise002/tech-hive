function Docs() {
  return (
    <div className="mt-15 max-w-3xl mx-auto p-4 md:p-8 bg-white rounded-lg shadow-lg text-gray-800">
      <h1 className="text-3xl font-bold mb-4 text-red">
        TechHive Editor Help Docs
      </h1>
      <p className="mb-6 text-lg">
        Welcome to the TechHive collaborative editor! Here’s how to make the
        most of your editing experience.
      </p>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <li>
              You can see comments and corrections directly on the article,
              added by reviewers.
            </li>
          </li>
          <li>
            See reviewers' cursors and selections as they provide feedback.
          </li>
          <li className="text-sm text-gray-500">
            Tip(Reviewers): Use clear and concise comments to ensure effective
            communication.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-2 text-red">Basic Editing</h2>
        <ul className="list-disc pl-6 space-y-2">
          <li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Click <span className="font-semibold">"Add Alt Text"</span> to open
            a modal and describe the image for accessibility.
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            ...
            or <span className="font-semibold">Dashboard</span> links to return
            to the main page.
          </li>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-2 text-red">Accessibility</h2>
        <ul className="list-disc pl-6 space-y-2">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            ...
            <br />
            <span className="font-semibold">A:</span> Click the image, then
            click the floating "Add Alt Text" button.
          </li>
          <li>
            <span className="font-semibold">Q:</span> Can I see who else is
            editing?
            <br />
            <span className="font-semibold">A:</span> Yes, you'll see other
            users' cursors and selections in real-time.
          </li>
        </ul>
      </section>
