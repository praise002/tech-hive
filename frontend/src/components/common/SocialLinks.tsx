          ...
          >
            ...
            <div className="m-3">
              {isSummarizing ? (
                ...
                <>
                  {/* <p className="bg-neutral p-4 rounded-lg leading-relaxed dark:text-gray-300">
                    {summaryContent}
                  </p> */}
                  <ul className="bg-neutral p-4 rounded-lg leading-relaxed dark:text-gray-300 list-disc list-inside space-y-2">
